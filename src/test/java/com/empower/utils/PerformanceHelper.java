...
//        // numericValue is in milliseconds for timing audits
//        return audits.getJSONObject(key).getDouble("numericValue");
//    }
//
//    public static void getLighthouseResult(
//            WebDriver driver,
//            String url,
//            String formFactor,
...
//                .put("executorOutput", "json"); // keep this
//
//        JSONObject payload = new JSONObject()
//                .put("action", "lighthouseAudit")
//                .put("arguments", arguments);
//
//        String script = "browserstack_executor: " + payload;
//
//        // --- execute ---
//        Object raw = ((JavascriptExecutor) driver).executeScript(script);
//        JSONObject root = toJson(raw);
//
//        // --- locate the LHR (Lighthouse Result) ---
//        // The response you posted has "report" (string) with the full LHR.
//        JSONObject lhr;
//        if (root.has("report")) {
...
//                (int) Math.round(lhr.getJSONObject("categories")
//                        .getJSONObject("performance")
//                        .getDouble("score") * 100.0);
//
//        // --- print summary ---
//        System.out.println("Lighthouse summary:");
//        System.out.println("URL: " + finalUrl);
//        System.out.printf("FCP: %.2f s%n", fcpMs / 1000.0);
//        System.out.printf("Speed Index: %.2f s%n", speedIndexMs / 1000.0);
//        System.out.printf("LCP: %.2f s%n", lcpMs / 1000.0);
//        System.out.printf("TBT: %.0f ms%n", tbtMs);   // keep TBT in ms
//        System.out.printf("CLS: %.3f%n", cls);
//        System.out.printf("Performance score: %d%n", performanceScore);
//
//    }
...
//        System.out.println("=== AVERAGE over " + n + " runs ===");
//        System.out.printf("FCP: %.2f s%n", avgFcp);
//        System.out.printf("Speed Index: %.2f s%n", avgSi);
//        System.out.printf("LCP: %.2f s%n", avgLcp);
//        System.out.printf("TBT: %.0f ms%n", avgTbt);
//        System.out.printf("CLS: %.3f%n", avgCls);
//        System.out.printf("Performance score: %.0f%n", avgPerf);
    }
}
